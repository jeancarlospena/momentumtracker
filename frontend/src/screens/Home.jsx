...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      <div onLoad={() => setMainLoaded(true)} className="message-section">
        <div className="content-wrapper">
          <div className={mainLoaded ? "img-back-business" : ""}>
      ...
      {mainLoaded && (
        <div
          className={`slowerLoad preloadSection ${mainLoaded ? "loaded" : ""}`}
        >
          <div className="container">
              ...
              <div className="informative-section-text">
                ...
                <div className="bullet-point">
                  ...
                  <p className="bullet-p">
                    Automated execution eliminates the need for manual trading —
                    but you’re never in the dark. Get real-time visibility into
                    strategy behavior, risk parameters, and performance metrics.
                  </p>
                </div>
                <div className="bullet-point">
                  <span className="bullet-heading">
                  ...
                  <p className="bullet-p">
                    Markets change — and so do we. Our systems continuously
                    evolve by adapting strategies based on live market data,
                    stress tests, and predictive modeling. Underperformers are
                    removed. Only the strongest survive.
                  </p>
                </div>
                <div className="bullet-point">
                  <span className="bullet-heading">
                  ...
                  <p className="bullet-p">
                    ...
                    strategy is built with embedded risk controls and monitored
                    for drawdown protection, so your capital stays protected
          ...
          <div className="container">
            <div className="informative-section">
              <div className="informative-section-text-left">
                ...
                <p className="bullet-p">
                  Stay connected to your strategies, performance, and goals —
                  all in one place. Import trades from most major brokers to
                  unlock a powerful, broker-synced trading journal and
                  performance hub.
                </p>
                <div className="bullet-section-container">
                  ...
                  <div className="check-bullet-point">
                    ...
                    />
                    <p className="bullet-p">
                      Risk management tools with return projections based on
                      input
                    </p>
                  </div>
